...
env = Environment(enemies=[1], playermode="ai", player_controller=player_controller(),enemymode="static", level=2, speed="fastest") 
...
for i in range(ini_g+1, gens):
    ...
    fit_pop[best] = float(avalia(np.array([pop[best] ]))[0]) # repeates best eval, for stability issues
