...
with open(f'Optimized_FStack/FStack_data_gather_lengths.csv', mode='w') as lengths_file:
    lengths_writer = csv.writer(lengths_file, delimiter=',', quotechar='\'', quoting=csv.QUOTE_NONNUMERIC)
    with open(f'Optimized_FStack/FStack_data_gather_rewards.csv', mode='w') as rewards_file:
