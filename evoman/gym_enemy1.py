    ...
    def update(self, dt, game):
        ...
        if atack3 == 1:
            ...
            for i in range(0, 8):
                ...
                if self.direction > 0:
                    self.twists.append(
                        Bullet_e1((self.rect.x + (i * rand), self.rect.y + 10 + (i * rand2)), 1, len(self.twists),
                                  game.sprite_e))
                else:
                    self.twists.append(
                        Bullet_e1((self.rect.x - (i * rand) + 46, self.rect.y + 10 + (i * rand2)), -1, len(self.twists),
                                  game.sprite_e))
