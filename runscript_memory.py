...
generations = 1500          #number of generations per run
population_size = 100       #pop size
mutation_baseline = 0.1     #minimal chance for a mutation event
mutation_multiplier = 0.3   #fitness dependent multiplier of mutation chance
...
for run in range(run_nr):
    ...
    # number of weights for multilayer with n hidden neurons
